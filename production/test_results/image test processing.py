...
with open("images deep accs and losses.txt", "r") as f:
    lines = f.readlines()
...
# plt.plot(t1, rand_accs, label='Bernoulli Accuracy Baseline')
plt.plot(t2, step_accs_comp, label='min_gates=[784, 512, 384, 256, 128, 5]')
# plt.plot(t2, rand_accs_comp, label='Bernoulli Accuracy Pooling')
plt.plot(t3, step_accs_comp2, label='min_gates=[1568, 1024, 768, 512, 256, 10]')
